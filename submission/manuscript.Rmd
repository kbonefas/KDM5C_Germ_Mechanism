...
We then assessed differentially methylated promoters in wild-type versus _Kdm5c_-KO exEpiLCs and found `r nrow(WTvsKO_hypo)` germline gene promtoers were significantly hypomethylated with _Kdm5c_ loss (Figure 6I). Hypomethylated promoters included genes consistently dysregulated in _Kdm5c_-KO cells, such as _D1Pas1_ (methlyation difference = `r signif(getWGBSinfo(WTvsKO_hypo, "D1Pas1", "meth.diff"),4)`%, q-value = `r signif(getWGBSinfo(WTvsKO_hypo, "D1Pas1", "qvalue"),3)`) (Figure 6J).
 
 ** notes **
- Something with if they're kdm5c targets
- Average % methylation in WT and 5CKO for EpiLC germline DEGs
