...
Previous RNA sequencing (RNA-seq) of the adult male _Kdm5c_-KO hippocampus revealed ectopic expression of some testis genes[@scandagliaLossKdm5cCauses2017]. It is currently unclear if the testis is the only tissue type misexpressed in the _Kdm5c_-KO brain. We thus characterized the role of KDM5C in brain tissue identity by systematically assessing the dysregulation of genes enriched in 17 mouse tissues[@liComprehensiveMouseTranscriptomic2017], using our published mRNA-seq datasets of the male adult amygdala and hippocampus for mice with constitutive knockout of _Kdm5c_[@vallianatosMutuallySuppressiveRoles2020].
