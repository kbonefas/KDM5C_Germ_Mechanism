...
Previous work suggests KDM5C represses germline genes during early development, since KDM5C binding is gradually lost at hippocampal germline DEG promoters over development[@scandagliaLossKdm5cCauses2017] and re-expression of KDM5C in neuronal cultures fails to suppress their transcription. 


* However, we identified many germline genes that were only dysregulated in _Kdm5c_-KO EpiLCs and not in the mature brain, including master regulators of meiosis and germline identity. 

* KDM5C was very recently shown to bind to Dazl in ESCs, unclear if it's bound to other master regulators

* Unclear if KDM5C's binding is maintained throughout development for these master regulators or also lost with differentiation, as KDM5C's binding at germline gene promoters has not been systematically compared. 

**check ESC chipseq, did they describe germline genes?**





* Since we found unique genes are dysregulated in EpiLCs 

* However, it is currently unclear if KDM5C 





 * previous studies only focused on binding at germline DEGs in the brain or focused on Dazl expression, no systematic characterization of KDM5C binding
...
* Altogether, these data indicate that while some germline genes are dysregulated due to direct loss of KDM5C binding during emryogenesis, secondary downstream mechanisms can also promote their aberrant transcription.  
