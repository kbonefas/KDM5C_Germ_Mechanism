...
- In wild-type cells, germline genes are known to accumulate CpGme at (CGIs) during the transition from naive to primed pluripotency.
- We first identified the number of germline genes with CGIs neighboring their promoter.
	- Found XXX% of germline genes had CGIs, XXX% of which were direct KDM5C targets in EpiLCs.
	- Gene ontology of CGI vs non-CGI germline genes (sperm vs meiotic?)

- We then identified germline genes that significantly gained CpGme, either within the gene promoter (TSS +/- 500bp) or at the promoter CGI, in wild-type exEpiLCs compared to ESCs (bismark and methylkit, q < 0.01).
	- Volcano plot, no-CGI vs CGI, color with KDM5C binding
	- Majority of germline gene promoters, regardless of CGI status, gained CpGme during WT differentiation

- Then compared CpGme accumulation in wild-type vs Kdm5c-KO exEpiLCs. 
	...
	- Although wild-type cells accumulated high levels of DNA methylation at germline gene promoters over the course of ESCs to exEpiLC differentiation, DNA methylation was markedly reduced in _Kdm5c_-KO exEpiLCs (Figure 6F). 
		- CGI vs Non-CGI germline genes, any significant differences?

- Altogether, this suggests KDM5C is dynamically regulated during ESC to EpiLC differentiation and promotes germline gene silencing via DNA methylation at CGIs during early embryogenesis.
