...
Although KDM5C is generally thought to supress transcription through erasure of histone 3 lysine 4 di- and trimethylation (H3K4me2/3)[@iwaseXLinkedMentalRetardation2007], recent studies in ESCs have suggested KDM5C's repression _Dazl_ is independent of its catalytic activity[@guptaGenomewideScreenReveals2023]. Somatic repression of germline genes is typically established during the transition between naive and primed pluripotency, which modeled in vitro as ESCs to EpiLC differentiation. In ESCs, chromatin regulators place repressive histone modifications at germline gene promoters (**note: check**), including H2AK119ub1 and H3K9me3. Germline genes are then silenced long-term by CpG DNA methylation in EpiLCs germline genes. As KDM5C's embryonic role in germline gene repression has only been characterized in ESCs, it is currently unclear if KDM5C is involved in the transition between ESCs and EpiLCs.
