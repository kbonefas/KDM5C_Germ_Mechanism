...
- CpGme was imparied at some germline genes, including ones expressed throughout life
-  Some regions, such as Dazl, were able to compensate for KDM5C loss, even though it gained H3K4me2 in EpiLCs. 
	- Multiple repressive mechanisms
We found _Kdm5c_-KO EpiLCs and the amygdala accumulate H3K4me2/3 around the TSS of germline genes, potential indicating KDM5C's cataltyic activity is necessary at later points in development. 

KDM5C's catalytic activity could be necessary to silence germline genes in EpiLCs, as 



as H3K4me3 impedes _de novo_ CpGme placement[@otaniStructuralBasisRecognition2009; @guoStructuralInsightAutoinhibition2015]. We found _Kdm5c_-KO cells accumulate H3K4me2/3 around the TSS of germline genes and have impaired CpGme placement at CGIs for select germline gene promoters. Our study therefore indicates the requirement of catalytic and non-catlytic gene regulatory mechanisms can change depending upon the locus and developmental stage. 
