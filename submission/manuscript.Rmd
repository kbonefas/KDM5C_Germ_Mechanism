...
- In somatic cells, germline genes are highly methylated at promoter CGIs, which are typically unmethylated for other classes of genes.
- The classic model for germline gene silencing is accumulation of CpGme at CGIs within their promoter, which is facilitated by E2F6/DP1 and MAX/MGA binding sites
- KDM5C does not have sequence specific binding, associates with PRC1.6 but likely not the major mechanisms of recruitment 
- KDM5C highly enriched at meiotic, promoter CGI germline genes
- A plausible mechanism for KDM5C-mediated germline gene silencing is KDM5C's removal of H3K4me2/3 at germline gene CGIs[@scandagliaLossKdm5cCauses2017; @aladhamiSystematicIdentificationFactors2023], given that (H3K4me2/3) oppose DNMTs and primarily do no colocalize with CpGme.
- Indeed we observed H3K4me2/3 accumulation at germline TSS and impaired CGI methylation at select germline genes. Loss of KDM5C strongly impairs CpGme at a subset of CGI-containing germline genes.
- However, Emerging work indicates many histone-modifying enzymes have non-cataltyic functions that influnce gene expression, sometimes even more potently than their catalytic roles[@aubertUnexpectedNoncatalyticRoles2019; @morganReevaluatingRolesHistonemodifying2020].
- KDM5C's catalytic activity was recently found to be dispensible for repressing _Dazl_ in ESCs [@guptaGenomewideScreenReveals2023]. In EpiLCs, Dazl still gained CpGme even with elevated H3K4me2. This suggests other redundant silencing mechanisms to ensure eventual CpGme of dazl, however other germline CGIs require KDM5C to ensure sufficient methylation
- Furthermore, our results indicates a histone modifier's catalytic and non-catlytic roles can change depending upon the locus and developmental stage. 

- It is yet unknown how KDM5C is recruited to germline gene promoters, given that KDM5C itself does not contain domains for sequence-specific binding[@iwaseXLinkedMentalRetardation2007]. In HeLa cells and ESCs[@tahilianiHistoneH3K4Demethylase2007; @guptaGenomewideScreenReveals2023], KDM5C assocaiates with members of the polycomb repressive complex 1.6 (PRC1.6), which is recruited to germline gene promoters through E2F6/DP1 and MGA/MAX heterodimers[@endohPCGF6PRC1SuppressesPremature2017; @stielowMGAL3MBTL2E2F62018]. While MAX and E2F6 motifs were enriched at KDM5C-bound germline genes in EpiLCs, only about one-third of promoters contained their consesus sequence. 



- Our list of germline genes
- We found less than 30% of germline-enriched genes have CGIs, yet the majority of CGI-free germline genes still gained significant CpGme around their TSS. 
	- CGI-containing = meiotic
- Loss of KDM5C binding at a subset of CGI-containing germline genes in EpiLCs, e.g. D1Pas1, Naa11, strongly impairs CpGme, resulting in their ectopic transcription in both EpiLCs and in the mature brain.
- Our germline gene list enabled us to identify germline-enriched genes activated independent of 

- This analysis revealed some germline genes can become active in _Kdm5c_-KO cells independent of KDM5C binding to their promoters. 
- Germline genes unbound by KDM5C primarily late-stage spermatogenesis genes that lacked CGIs and significantly enriched for RFX transcription factors, including RFX2, a central regulator of spermiogenesis[@kistlerRFX2MajorTranscriptional2015; @wuTranscriptionFactorRFX22016]. 

Another notable KDM5C-unbound DEG is _Stra8_, a meiotic transcription factor that is turned on in germ cells with retionic acid signaling and DAZL expression[@endoPeriodicRetinoicAcid2015; @bowlesRetinoidSignalingDetermines2006]. Misexpression of _Dazl_ and _Rfx2_ and their downstream targets in _Kdm5c_-KO cells suggests that once activated, ectopic germline genes can then turn on other aberrant germline programs to loosely mimic germ cell development. 


- KDM5C loss also activates RFX2 transctiption factors whose binding sites are enriched at non-CGI spermiogenesis genes.

- CGIs are resistant
	- https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5001583/
	- https://pubmed.ncbi.nlm.nih.gov/14504655/



- Our results indicate KDM5C's removal of H3K4me2/3 may be necessary at a subset of CGI-containing germline genes, given they fail to accumulate CpGme during EpiLC differentiation. These CpGme-sensitive germline genes, such as _D1Pas1_ and _Naa11_, are also de-repressed in the mature _Kdm5c_-KO brain and consistently dysregulated in multiple _Kdm5c_-KO datasets[@scandagliaLossKdm5cCauses2017].

- H3K4me3 and CpGme typically do not colocalize
	- https://pubmed.ncbi.nlm.nih.gov/17334365/
	- https://www.nature.com/articles/s41594-017-0013-5
	- https://pubmed.ncbi.nlm.nih.gov/23664763/
	- https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2718496/
	- https://pubmed.ncbi.nlm.nih.gov/19581485/

- Contrastingly, many germline genes had only a modest reduction in CpGme, including _Dazl_ even though its TSS accumulated substantial H3K4me2. 
- Multiple regulators repress dazl, dazl is not expressed in the mature _Kdm5c_-KO brain
	E2F6/MGA/MAX
...
- Combine germline gene list, CGI, RFX information together. 
	- Benefit of the list is finding CGI difference and kdm5c indirect mechanisms of de-repression
    - List of genes enables us to propose this model
    - CGI positive meiosis/germline formation regulators turned on → these turn on CGI-negative late stage regulators → These promote downstream dysregulation long term
