...
- read in the homer results txt file above here
- Add in euler KDM5C-bound vs KDM5C-unbound coloring
		- Make sure instances window is 500 bp, change if not


- Germline genes repressed by other histone modifying enzymes have shared genomic features around the TSS to suppress their expression, such as motifs for E2F6/DP1 (E2F) and MGA/MAX (E-box) and CpG islands (CGIs). We asessed transcription factor motifs enriched at germline gene promoters that are either bound or unbound by KDM5C in EpiLCs using HOMER[XXX] (TSS +/- 500 bp, q-value < 0.1). MAX and E2F6 binding sites were significantly enriched at KDM5C-bound germline genes, with about one third of KDM5C-bound promoters contained one or both of these motifs (Figure 4). Contrastingly, KDM5C-unbound germline genes were enriched for RFX transcription factor motifs, a family of transcription factors important for ciliogenesis. The RFX X-box motif is present at XXX% of KDM5C-unbound promoters (Figure 4).
...
Motif Discussion
- only 1/3 had max/e2f - Unlikely to be the major recruitment mechanism for KDM5C (discussion?)
