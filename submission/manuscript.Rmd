...
- Germline genes repressed by other histone modifying enzymes have shared genomic features around the TSS to suppress their expression, such as motifs for E2F6/DP1 (E2F) and MGA/MAX (E-box) binding.
	- We asessed genomic features enriched at KDM5C-bound versus unbound gemrline gene promoters using HOMER.
		- window I analyzed
