...
- DNAme and CpG islands
	...
	- Germline genes are methylated at promoter CGIs, which are typically not methylated in other gene types
	...
	- We found not all germline-enriched genes have CGIs, but still gain CpGme around TSS. Unclear what the recruitment mechanism is for these genes
	- Other studies on germline gene repressors have shown they are importnat for CGIme, unclear if they also participate in non-CGI TSS CpGme
	- CGIs highly determine KDM5C recruitment to germline gene promoters and KDM5C germline gene CGI methylation.
		- KDM5C is known to be enriched at CGIs (in neurons? are these methylated? or is its germline CGI function likely different from its somatic CGI function). 
	- Different classes of germline genes use distinct silencing mechanisms 
	

The above work provides the mechanistic foundation for KDM5C's role in germline gene repression and offers novel insight into how dysregulation in _Kdm5c_-KO tissue identity changes over the course of development. However, the contribution of ectopic, tissue-specific genes towards _Kdm5c_-KO neurological impairments is still unknown. In addition to germline genes, we also found significant enrichment of muscle, liver, and even ovary-biased genes aberrantly expressed within the male _Kdm5c_-KO brain. Intriguingly, select liver and muscle-biased DEGs do have known roles within the brain, such as the liver-enriched lipid metabolism gene _Apolipoprotein C-I (Apoc1)_ [@roulandRoleApolipoproteinC12022] that is highly expressed in the _Kdm5c_-KO amygdala and hippocampus. _Apoc1_ overexpression in the mouse brain can impair learning and memory[@abildayevaHumanApolipoproteinCI2008] and is implicated in Alzheimer's disease in humans[@leducAPOECholesterolHomeostasis2010]. Thus, KDM5C may be crucial for neurodevelopment by fine-tuning the expression of tissue-erniched, dosage-sensitive genes like _Apoc1_. While the impact of ectopic germline transcripts upon neurodevelopment is currently unknown, some models of other chromatin-linked neurodevelopmental disorders also display impaired soma-germline demarcation[@bonefasSomatogermlineTransformationChromatinlinked2021; @velascoGermlineGenesHypomethylation2014; @waltonDnmt3bPrefersGerm2014; @schaeferControlCognitionAdaptive2009; @samacoCrhOprm1Mediate2012]. Like KDM5C, the chromatin regulators underlying these conditions - DNA methyltransferase 3b (DNMT3B), H3K9me1/2 methyltransferases G9A/GLP, methyl-CpG -binding protein 2 (MECP2) - primarily silence gene expression. Thus, KDM5C is among a growing cohort of chromatin-linked neurodevelopmental disorders that have a similar underlying phenotype of germline versus soma dysregulation, however further research is required to determine the impact of these germline genes and the extent to which this phenomenon occurs in humans. 
