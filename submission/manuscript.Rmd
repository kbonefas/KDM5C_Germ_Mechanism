...
It is unclear how KDM5C is recruited to germline genes, given that KDM5C itself does not contain domains for sequence-specific binding. In HeLa cells and ESCs[@tahilianiHistoneH3K4Demethylase2007; @guptaGenomewideScreenReveals2023], KDM5C assocaiates with members of the polycomb repressive complex 1.6 (PRC1.6), which is recruited to germline gene promoters through E2F6/DP1 and MGA/MAX heterodimers[@endohPCGF6PRC1SuppressesPremature2017; @stielowMGAL3MBTL2E2F62018]. While MAX and E2F6 motifs were enriched at KDM5C-bound germline promoters in EpiLCs, only about one-third of promtoers contained their consesus sequence. Additionally, germline genes like _Stra8_ can become active in _Kdm5c_-KO cells independent of KDM5C binding to their promoters. _Stra8_ is a meiotic transcription factor that is typically turned on in the presence of retinoic acid signaling and DAZL[@endoPeriodicRetinoicAcid2015; @bowlesRetinoidSignalingDetermines2006], which is a direct KDM5C target. Germline genes unbound by KDM5C were primarily late-stage spermatogenesis genes and significantly enriched for RFX transcription factors that promote the transcription of cilia and flagellar genes[@swobodaRFXTypeTranscriptionFactor2000; @ashiqueRfx4TranscriptionFactor2009]. One of the top RFX members enriched included RFX2, a central regulator of spermiogenesis[@kistlerRFX2MajorTranscriptional2015; @wuTranscriptionFactorRFX22016] whose mRNA is also expressed in _Kdm5c_-KO EpiLCs. Altogether, these data suggest that once germline genes are activated due to loss of direct KDM5C repression, they can activate other ectopic germline programs downstream that loosely mimic germline development. 
