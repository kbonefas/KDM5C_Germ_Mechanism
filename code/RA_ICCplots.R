...
q <- ggboxplot(DAZL_100nMRA, x = 'genotreat', y = 'Percent', color = "black", fill="Genotype",
    add.params = list(size = 1), add =  "dotplot", xlab = " ") + #palette = EpiLC_XY_palette
    #rremove("legend") +
    stat_compare_means(comparisons = my_comparisons, method="t.test", label = "p.signif") 
q <- ggpar(q, x.text.angle = 25, font.main = "bold") #ylim = c(0,40),
