...
METHoverBED <- function(bedfile, outname){
	...
	write.table(dm.regions, paste0("../results/methylKit/WGBS_restab_regionCounts_", outname,"_WT_min3_ESCvsEpiLC.csv"), sep = ',', row.names = FALSE, quote = FALSE)
	...
	write.table(myDiff_regions, paste0("../results/methylKit/WGBS_getmethyldiff_", outname,"_p10_min3_q01_WT_ESCvsEpiLC.csv"), sep = ',', row.names = FALSE, quote = FALSE)
